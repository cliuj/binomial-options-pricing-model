...
Once the strike price is reached or passed, the options contract is considered ``in-the-money"\footnote{In-the-money depends on the type of the option\footref{option rules}.} and can be reasonably exercised for profit.
