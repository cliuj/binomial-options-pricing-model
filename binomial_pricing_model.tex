...
The binomial options pricing model aims to find the valuation of the chosen option at discrete times ${(t)}$ based on various inputs given.
  ...
  \begin{tikzpicture}[>=stealth, sloped, baseline]
    \matrix (tree) [%
      ...
      \node[bullet, left=0mm of tree-3-2.west,
        ...
        label={[label distance=2mm]0:${XV_{t,n}}$},
        label={[label distance=2mm]270:${OV_{t,n}}$}
        ](b-3-2){};
      ...
      \matrix [draw,below left] at (current bounding box.south) {
        ...
        \node [label=right:${OV_{t, n} =}$ \text{option value at time period ${t}$}] {}; \\
      };
  \end{tikzpicture}
