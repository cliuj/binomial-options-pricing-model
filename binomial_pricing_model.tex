...
This binomial tree is more of a lattice of Bernoulli processes in which each path represents a Bernoulli process because at each (non end/start) node there are two directional outcomes of the stock: up or down.
